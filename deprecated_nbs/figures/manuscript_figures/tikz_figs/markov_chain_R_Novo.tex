...
\begin{tikzpicture}[start chain = going right,
  ...
  \draw    (3)  edge[bend left, thick, red]  (4);
  ...
  \node at (7.1,1.1) [draw=none, rectangle, rotate=0, text=blue] (g1) {\sf \small 0.14 (NP)};
  \node at (7,0.7) [draw=none, rectangle, rotate=0, text=blue] (g1) {\sf \small 0.12 (P)};
