...
\node at (-0.1,12.5) [draw=none, rectangle, fill=black!20,rotate=90] (g1) {\sf \scriptsize \emph{E. coli} OP50};

\node at (-0.1,9) [draw=none, rectangle, fill=black!20, rotate=90] (g1) {\sf \scriptsize \emph{Novosphingobium} sp. L76};

\node at (4.5,4.4) [draw=none, rectangle, fill=black!20,rotate=90] (g1) {\sf \scriptsize \emph{E. coli} OP50};

\node at (4.5,1) [draw=none, rectangle, fill=black!20, rotate=90] (g1) {\sf \scriptsize \emph{Novosphingobium} sp. L76};
