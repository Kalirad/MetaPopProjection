...
% 3 
\node [rectangle, draw,  fill=white, minimum size=1.2cm] at (1, 8) (a) {\huge $S_{11}$};

\node [rectangle, draw, fill=white, minimum size=1.2cm] at (1 + 2.7, 8) (b) {\huge $S_{12}$};

\node [rectangle, draw, fill=white, minimum size=1.2cm] at (1 + 2*2.7, 8) (c) {\huge $S_{13}$};


\node [rectangle, draw,  fill=white, minimum size=1.2cm] at (1, 8 - 2.7) (a1) {\huge $S_{21}$};

\node [rectangle, draw, fill=white, minimum size=1.2cm] at (1 + 2.7, 8 - 2.7) (b1) {\huge $S_{22}$};

\node [rectangle, draw, fill=white, minimum size=1.2cm] at (1 + 2*2.7, 8 - 2.7) (c1) {\huge $S_{23}$};

\node [rectangle, draw,  fill=white, minimum size=1.2cm] at (1, 5.3-2.7) (a2) {\huge $S_{31}$};

\node [rectangle, draw, fill=white, minimum size=1.2cm] at (1 + 2.7, 5.3-2.7) (b2) {\huge $S_{32}$};

\node [rectangle, draw, fill=white, minimum size=1.2cm] at (1 + 2*2.7, 5.3-2.7) (c2) {\huge $S_{33}$};
